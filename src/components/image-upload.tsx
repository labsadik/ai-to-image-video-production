...
export type UploadedReference = { assetId: string; path: string; previewUrl: string; name: string; size: number };
...
export function ImageUpload({ projectId, current, onChange }: Props) {
  ...
  async function handleFile(file: File) {
    ...
    try {
      ...
      onChange({ assetId: signData.assetId, path: completeData.asset.storage_path, previewUrl, name: file.name, size: file.size });
    } catch (error) {

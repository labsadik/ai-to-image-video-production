...
export const DISPLAY_PLANS: readonly DisplayPlan[] = [
  ...
  { id: 'pro', name: 'Starter', description: 'For creators who need more generation and analysis capacity.', monthlyCredits: 50, maxUploadsPerProject: 10, watermark: false, monthlyFallbackMinor: 1000, features: ['50 credits / month', 'Basic / Medium / Ultra image generation', 'Basic / Medium / High image analysis', 'Standard 5-second video · 10 credits', 'No visible watermark', 'Up to 10 uploads / project'], icon: Sparkles, premium: true },
